function updateBulbOpacity(opacity = null) {
  ...
  const ballTypes = {
    ...
    ball7: { className: "h-[9%] w-[9%]", src: "../../../assets/direct-ethanol-fuel-cell/h+1.png", interval: 2 },
    ball8: { className: "h-[5%] w-[5%]", src: "../../../assets/direct-ethanol-fuel-cell/h+1.png", interval: 2 },
    ball9: { className: "h-[9%] w-[9%]", src: "../../../assets/direct-ethanol-fuel-cell/h+1.png", interval: 2 },
    ball10: { className: "h-[5%] w-[5%]", src: "../../../assets/direct-ethanol-fuel-cell/h+1.png", interval: 2 },
    ball11: { className: "h-[4%] w-[8%]", src: "../../../assets/Organic_matter.png", interval: 2 },
    ...
    ball16: { className: "h-[4%] w-[8%]", src: "../../../assets/Organic_matter.png", interval: 2 },
  };
